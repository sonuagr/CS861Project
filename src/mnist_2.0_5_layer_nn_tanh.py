...
with tf.Session() as sess:
    ...
    np.savetxt("W1_val_tanh.csv", W1_val, delimiter=",")
    np.savetxt("b1_val_tanh.csv", b1_val, delimiter=",")
    np.savetxt("W2_val_tanh.csv", W2_val, delimiter=",")
    np.savetxt("b2_val_tanh.csv", b2_val, delimiter=",")
    np.savetxt("W3_val_tanh.csv", W3_val, delimiter=",")
    np.savetxt("b3_val_tanh.csv", b3_val, delimiter=",")
    np.savetxt("W4_val_tanh.csv", W4_val, delimiter=",")
    np.savetxt("b4_val_tanh.csv", b4_val, delimiter=",")
    np.savetxt("W5_val_tanh.csv", W5_val, delimiter=",")
    np.savetxt("b5_val_tanh.csv", b5_val, delimiter=",")
